...
object test {
  ...
  title.toXML                                     //> res1: scala.xml.Elem = <datafield tag="245">
                                                  //| 	  </datafield>
  new File(".").getAbsolutePath()                 //> res2: java.lang.String = /home/diego/Programas/eclipse/.
  val parser = new MarcParser("workspace/scalamarc/src/marc/sandburg.mrc")
                                                  //> parser  : marc.MarcParser = marc.MarcParser@37ed9554
  ...
  val record = parser.parse                       //> record  : marc.Record = Leader
                                                  ...
                                                  //| 520    a A poem about numbers and their characteristics. Features anamorphic
                                                  //| , or distorted, drawings which can be restored to normal by viewing from a p
                                                  //| articular angle or by viewing the image's reflection in the provided Mylar c
                                                  //| one.
  ...
  parser.getDataFields.mkString("\n")             //> res12: String = "   92005291 
                                                  ...
                                                  //| 1 aRand, Ted,eill."
  val subs = parser.mergeDirectoryWithFields      //> subs  : scala.collection.mutable.MutableList[(marc.Entry, String)] = Mutable
                                                  //| List((001 0013 00000,"   92005291 "), (003 0004 00013,DLC), (005 0017 00017,
                                                  //| 19930521155141.9), (008 0041 00034,"920219s1993    caua   j      000 0 eng  
                                                  //| "), (010 0017 00075,"  a   92005291 "), (020 0025 00092,"  a0152038655 :c
                                                  //| $15.95"), (040 0018 00117,"  aDLCcDLCdDLC"), (042 0009 00135,"  alcac"),
                                                  //|  (050 0026 00144,00aPS3537.A618bA88 1993), (082 0016 00170,00a811/.52220
                                                  //| ), (100 0032 00186,1 aSandburg, Carl,d1878-1967.), (245 0086 00218,10aAri
                                                  //| thmetic /cCarl Sandburg ; illustrated as an anamorphic adventure by Ted Ran
                                                  //| d.), (250 0012 00304,"  a1st ed."), (260 0052 00316,"  aSan Diego :bHarco
                                                  //| urt Brace Jovanovich,cc1993."), (300 0049 00368,"  a1 v. (unpaged) :bill.
                                                  //|  (some col.) ;c26 cm."), (500 0040 00417,"  aOne Mylar sheet included in p
                                                  //| ocket."), (520 0228 00457,"  aA poem about numbers and their characteristic
                                                  //| s. Features anamorphic, or distorted, drawings which can be restored to norm
                                                  //| al by viewing from a particular angle or by viewing the image's reflection i
                                                  //| n the provided Mylar cone."), (650 0033 00685," 0aArithmeticxJuvenile poet
                                                  //| ry."), (650 0033 00718," 0aChildren's poetry, American."), (650 0024 00751,
                                                  //| " 1aArithmeticxPoetry."), (650 0021 00775," 1aAmerican poetry."), (650 00
                                                  //| 23 00796," 1aVisual perception."), (700 0021 00819,1 aRand, Ted,eill.))
  subs.get(13).get._2.split(Marc.SUBFIELD_DELIMITER)
	...
	parser.getFields.mkString("\n")           //> res14: String = 001    92005291 
                                                  ...
                                                  //|  particular angle or by viewing the image's reflection in the provided Myla
                                                  //| r cone.
                                                  //| 650  1 a Visual perception.
                                                  //| 650  1 a American poetry.
                                                  //| 650  1 a Arithmetic
	...
	record                                    //> res15: marc.Record = Leader
                                                  ...
                                                  //| 700 1  a Rand, Ted,
                                                  //| 700 1  e ill.
  val writer = new MarcXMLWriter                  //> writer  : marc.MarcXMLWriter = marc.MarcXMLWriter@66c07f58
  writer.write("sandburg.xml", record)
}